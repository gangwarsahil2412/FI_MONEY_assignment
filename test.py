...
[15:18, 26/07/2025] Ritesh Pandey ECE 115: import requests
import json
import time
import random
...
def test_login(username=None):
    ...
    test_username = username if username else "ritesh"
...
def run_all_tests():
    ...
    if not token:
        print("Login failed. Trying with existing user 'ritesh'...")
        token = test_login("ritesh")
